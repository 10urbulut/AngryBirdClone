...
//  AngryBirdClone
//
//  Created by Onur Bulut on 5.09.2023.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
      /*  let texture = SKTexture(imageNamed: "bird")
        birdTwo = SKSpriteNode(texture: texture)
        birdTwo.position = CGPoint(x:-self.frame.width / 4, y:-self.frame.height / 4)
        birdTwo.size = CGSize(width: self.frame.width / 16, height:self.frame.height / 10)
        birdTwo.zPosition = 1
